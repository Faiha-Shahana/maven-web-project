...
public class RegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String p = request.getParameter("employee_phone");
		String e = request.getParameter("employee_pay");
		String c = request.getParameter("salary_status");
		...
		try {
		 ...
		 "jdbc:mysql://localhost:3306/employeedetails", "root", "tG001669");
		...
		writer.println("<h1>" + "You have successfully registered an employee!" +
		"</h1>");
		writer.close();
		}
		}
